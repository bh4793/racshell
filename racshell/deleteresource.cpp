...
{
    argparse::ArgumentParser program("deleteresource");

    program.add_argument("resource")
        .help("resource profile name to delete, e.g. IRR.RADMIN.**");
    ...
    std::cout << "Resource profile " << resource << " deleted successfully from class " << resource_class << ".\n";
    return 0;
}
