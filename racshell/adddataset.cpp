...
{
    argparse::ArgumentParser program("adddataset");

    program.add_argument("dataset")
        .help("dataset profile name to create, e.g. ESWIFT.TEST.**");

    program.add_argument("-t", "--traits")
        .help("traits to set, e.g. base:universal_access=None base:owner=eswift")
